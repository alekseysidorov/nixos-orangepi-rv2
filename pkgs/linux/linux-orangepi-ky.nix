...
(buildLinux (
  ...
  // {
    ...
    kernelPatches = [
      ...
      (fetchKernelPatchArchive {
        name = "patch-6.6.64-65.xz";
        hash = "sha256-/b9VPAOIteUQ4jA5RqbP0mvNA7xiOJ+WdaipB5E2Ue4=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.65-66.xz";
        hash = "sha256-TP282k+l0TxQbWfqxw1kvhQyRMlAEuBM/dQ0gCzhTec=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.66-67.xz";
        hash = "sha256-TaJu/j5TfiKqXujeUnllefD6iwSb/n/BjtONdatqnno=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.67-68.xz";
        hash = "sha256-GgpZNXWV1jLdj8h+0P79EUOUmW9qbHjRoGf/QopALtE=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.68-69.xz";
        hash = "sha256-mj6pH5xUpuclNC3Fy0aV5CPXzSczoo+lgmDDsf9tL5M=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.69-70.xz";
        hash = "sha256-fOXrgcCxbRlDA8k0s1s7VS670jIVEw1j+8Rle0ah5+w=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.70-71.xz";
        hash = "sha256-CA6ft0Q9MQnDMye6tQ8TvgrnS1HpGOx1XTIGdeAmCC4=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.71-72.xz";
        hash = "sha256-dF7BZ4ltcU6l6+3hMGzKehkLiEXE+zeBZTqMsvtRCmg=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.72-73.xz";
        hash = "sha256-Dx5bXfDOPX/UCBOqCMYMYM/s4DH0nR/JxaIXlfYW0gw=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.73-74.xz";
        hash = "sha256-b8zNPBFe3c+L7gBinhY71KzaNkKSnOL5pGJFimZHxPg=";
      })
      (fetchKernelPatchArchive {
        name = "patch-6.6.74-75.xz";
        hash = "sha256-viHS2I8Z9N2iUs0AIXUsF8EC+7z8QlbtvQKyUAoalN4=";
      })
    ];
